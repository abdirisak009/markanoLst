    ...
    if (existing.length > 0) {
      ...
      await sql`
        ...
        SET
          ...
          custom_store_name = ${formData.custom_store_name || null},
          custom_store_url = ${formData.custom_store_url || null},
      ...
      await sql`
        INSERT INTO ecommerce_wizard_submissions (
          ...
          custom_store_name, custom_store_url,
          ...
          ${formData.custom_store_name || null}, ${formData.custom_store_url || null},
